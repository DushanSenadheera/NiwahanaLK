    ...
    <div class="landing">
        <header>
            <nav>
                ...
                ?>
                    ...
                    <a href="logout.php"><i class="fa fa-sign-out" style="font-size: 18px; padding:0; margin:0;"></i></a>
        ...
        <div class="search-box">
            <form action="search.php" method="POST" id="searchForm">
                <input type="search" name="searchCity" placeholder="Search by city...">
...
?>
    ...
    <div class="container">
        ...
        <div class="ads">
            ...
            $city = $_REQUEST['searchCity'];

            $sql1 = "SELECT * FROM `advertisement` WHERE `location` LIKE '%$city%'";
